              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
					<div class="animatedParent">
						<h1 class="animated fadeInDown">Hello Iti...</h1>
						<p class="animated fadeInUp">Some say tht beauty is in a drop of water. Well, in tht case u're the ocean Iti !</p>
					</div>
			   </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                  <a href="#about" class="learn-more-btn btn-scroll">Okay Iti Click here :)</a>
                </div>
              </div>
            </div>
    </section>
        ...
        <nav class="navbar navbar-custom" role="navigation">
                              <div class="container">
                                    <div class="row">
                                          <div class="col-md-2">
                                                   <div class="site-logo">
                                                            <a href="index.html" class="brand">ITI</a>
                                                    </div>
                                          </div>
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li class="active"><a href="#intro">Iti Home</a></li>
                                                                  <li><a href="#about">About Iti</a></li>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">What i feel for you..</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 animatedParent">		
				<div class="text-center">
					<p>
					You r the preetiest girl i have ever met in this world... Most adorable and beautifull in this whole world..
					</p>
					<p>
					The best thing about you.. "your beautifull eyes.. and ofcourse yours smile too..."
					</p>
					<a href="#service" class="btn btn-skin btn-scroll">Okay now click here beautifull.. </a>
				</div>
            </div>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">What can I do for you</h2>
					<div class="divider-header"></div>
					</div>
					</div>
				</div>
			...
			<div class="col-md-12">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						...
						<div class="divider-header"></div>
						<p>
						Please accept invite on insta.. so that i could use your beautifull pictures to make this web page more beautifull..
						</p>
						<a  class="btn btn-skin">okay. so that all for now.. :)</a>
					</div>
                </div>
				</div>
            </div>
			...
			<div class="row">
				<div class="col-md-6">
					<ul class="footer-menu">
						<li><a href="#">ITI Home</a></li>
						<!-- <li><a href="#">Press release</a></li> -->
					</ul>
				</div>
				<div class="col-md-6 text-right copyright">
					&copy;Copyright - Iti Verma
                    <div class="credits">
                        <!-- 
